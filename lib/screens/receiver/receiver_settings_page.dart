...
class ReceiverSettingsPage extends StatefulWidget {
  ...
  const ReceiverSettingsPage({Key? key, required this.currentUsername})
    : super(key: key);

  @override
  _ReceiverSettingsPageState createState() => _ReceiverSettingsPageState();
}
  ...
  Future<void> _updateSettings() async {
    ...
    try {
      ...
      final response = await http
          .put(
            Uri.parse('${ApiConfig.baseUrl}/receiver/settings'),
            headers: {
